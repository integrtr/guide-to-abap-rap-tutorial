...
@EndUserText.label: 'Projection View of ZI_RAP_E2E_AEMPL'
@Metadata.allowExtensions: true
define view entity ZC_RAP_E2E_AEMPL_M as projection on ZI_RAP_E2E_AEMPL
{
  ...
  key EmploymentUUID      as EmploymentUUID,
      ...
      /* Associations */
      _Employee : redirected to parent ZC_RAP_E2E_AEMP_M
}
